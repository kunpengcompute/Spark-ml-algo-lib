...
class Learner : public Model, public Configurable, public rabit::Serializable {
 public:
   ...
   */
  virtual void UpdateOneIter(int iter, std::shared_ptr<DMatrix> train, float* p_last_round_best_loss) = 0;

  virtual void UpdateOneIter(int iter, std::shared_ptr<DMatrix> train) {
    UpdateOneIter(iter, train, NULL);
  };
  ...
  virtual void BoostOneIter(int iter,
                            ...
                            float* p_last_round_best_loss = nullptr) = 0;
  /*!
