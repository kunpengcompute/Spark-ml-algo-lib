...
if __name__ == "__main__":
    ...
    maybe_makedirs("boostkit-xgboost4j/src/main/resources/lib")
    cp("../lib/" + library_name, "boostkit-xgboost4j/src/main/resources/lib")

    print("copying pure-Python tracker")
    cp("../dmlc-core/tracker/dmlc_tracker/tracker.py",
       "boostkit-xgboost4j/src/main/resources")

    print("copying train/test files")
    maybe_makedirs("boostkit-xgboost4j-spark/src/test/resources")
    with cd("../demo/regression"):
    ...
    for file in glob.glob("../demo/regression/machine.txt.t*"):
        cp(file, "boostkit-xgboost4j-spark/src/test/resources")
    for file in glob.glob("../demo/data/agaricus.*"):
        cp(file, "boostkit-xgboost4j-spark/src/test/resources")

    maybe_makedirs("boostkit-xgboost4j/src/test/resources")
    for file in glob.glob("../demo/data/agaricus.*"):
        cp(file, "boostkit-xgboost4j/src/test/resources")
