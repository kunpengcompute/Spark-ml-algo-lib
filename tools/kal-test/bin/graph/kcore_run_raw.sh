...
source ${CONF_DIR}/kcore/kcore_spark_raw.properties
...
executor_emoryOverhead_val="executorMemoryOverhead_${dataset_name}"
...
output_path="${output_path_prefix}/kcore/raw/${dataset_name}"
