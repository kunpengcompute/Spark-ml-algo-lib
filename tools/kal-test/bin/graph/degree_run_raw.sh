...
source conf/graph/degree/degree_spark_raw.properties
...
hdfs dfs -rm -r -f "/tmp/graph/result/degree/${dataset_name}_${api_name}_raw"
...
num_partitions="${api_name}_${dataset_name}_numPartitions"
