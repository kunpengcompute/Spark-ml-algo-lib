...
scp lib/boostkit-ml-acc_2.11-1.3.0-${spark_version_val}.jar lib/boostkit-ml-core_2.11-1.3.0-${spark_version_val}.jar lib/boostkit-ml-kernel-2.11-1.3.0-${spark_version_val}-${cpu_name}.jar root@agent1:/opt/lib/ml
scp lib/boostkit-ml-acc_2.11-1.3.0-${spark_version_val}.jar lib/boostkit-ml-core_2.11-1.3.0-${spark_version_val}.jar lib/boostkit-ml-kernel-2.11-1.3.0-${spark_version_val}-${cpu_name}.jar root@agent2:/opt/lib/ml
scp lib/boostkit-ml-acc_2.11-1.3.0-${spark_version_val}.jar lib/boostkit-ml-core_2.11-1.3.0-${spark_version_val}.jar lib/boostkit-ml-kernel-2.11-1.3.0-${spark_version_val}-${cpu_name}.jar root@agent3:/opt/lib/ml
...
--conf "spark.driver.extraClassPath=/opt/netlib/*:lib/kal-test_2.11-0.1.jar:lib/snakeyaml-1.19.jar:lib/boostkit-ml-acc_2.11-1.3.0-${spark_version_val}.jar:lib/boostkit-ml-core_2.11-1.3.0-${spark_version_val}.jar:lib/boostkit-ml-kernel-2.11-1.3.0-${spark_version_val}-${cpu_name}.jar" \
