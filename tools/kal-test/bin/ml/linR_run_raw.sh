...
source conf/ml/linR/linR_spark_raw.properties

dataset_name=$1
api_name=$2
cpu_name=$(lscpu | grep Architecture | awk '{print $2}')
model_conf=${dataset_name}_${api_name}
...
./lib/kal-test_2.11-0.1.jar ${model_conf} ${data_path_val} ${cpu_name} ${is_raw} ${spark_conf}
