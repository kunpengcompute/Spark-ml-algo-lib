...
source conf/ml/dt/dt_spark_raw.properties
...
num_executors=${algorithm_type}"_"${dataset_name}"_numExectuors"
executor_cores=${algorithm_type}"_"${dataset_name}"_executorCores"
executor_memory=${algorithm_type}"_"${dataset_name}"_executorMemory"
extra_java_options=${algorithm_type}"_"${dataset_name}"_extraJavaOptions"
