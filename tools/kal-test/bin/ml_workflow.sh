...
#BO
bash bin/ml/bo_run.sh BostonHousing ${is_raw} ${if_check} 2>&1 | tee -a logs/bo_BostonHousing_${type}.log
...
# encoder
bash bin/ml/encoder_run.sh encoder_400m ${is_raw} ${if_check} 2>&1 | tee -a logs/encoder_encoder_400m_${type}.log
...
#hdb
bash bin/ml/hdb_run.sh Hibench1m_100 ${is_raw} ${if_check} 2>&1 | tee -a logs/hdb_Hibench1m_100_${type}.log
bash bin/ml/hdb_run.sh Hibench1m_200 ${is_raw} ${if_check} 2>&1 | tee -a logs/hdb_Hibench1m_200_${type}.log
...
#lgbm
bash bin/ml/lgbm_run.sh regression mnist8m ${is_raw} ${if_check} 2>&1 | tee -a logs/lgbmr_mnist8m_${type}.log
bash bin/ml/lgbm_run.sh regression higgs ${is_raw} ${if_check} 2>&1 | tee -a logs/lgbmr_higgs_${type}.log
bash bin/ml/lgbm_run.sh classification mnist8m ${is_raw} ${if_check} 2>&1 | tee -a logs/lgbmc_mnist8m_${type}.log
bash bin/ml/lgbm_run.sh classification higgs ${is_raw} ${if_check} 2>&1 | tee -a logs/lgbmc_higgs_${type}.log
...
#nmf
bash bin/ml/nmf_run.sh CSJ ${is_raw} ${if_check} 2>&1 | tee -a logs/nmf_CSJ_${type}.log
...
#svm
bash bin/ml/svm_run.sh ECBDL14 fit ${is_raw} ${if_check} 2>&1 | tee -a logs/svm_ECBDL14_fit_${type}.log
bash bin/ml/svm_run.sh ECBDL14 fit1 ${is_raw} ${if_check} 2>&1 | tee -a logs/svm_ECBDL14_fit1_${type}.log
bash bin/ml/svm_run.sh ECBDL14 fit2 ${is_raw} ${if_check} 2>&1 | tee -a logs/svm_ECBDL14_fit2_${type}.log
...
# te
bash bin/ml/te_run.sh movielens ${is_raw} ${if_check} 2>&1 | tee -a logs/te_movielens_${type}.log
bash bin/ml/te_run.sh taobao ${is_raw} ${if_check} 2>&1 | tee -a logs/te_taobao_${type}.log
bash bin/ml/te_run.sh criteo40m ${is_raw} ${if_check} 2>&1 | tee -a logs/te_criteo40m_${type}.log
