...
./bin/graph/modularity_run.sh uk no 2>&1 | tee -a logs/modularity_uk_${type}.log
./bin/graph/modularity_run.sh arabic no 2>&1 | tee -a logs/modularity_arabic_${type}.log
